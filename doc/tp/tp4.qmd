...
Le but des questions suivantes va être d'afficher le nombre de partie jouées en tournoi et hors tournoi.
...
- [ ] Vérifiez que cette vue contient 980 enregistrements
...
- [Correction TP4](./correction/tp4.sql)
:::
