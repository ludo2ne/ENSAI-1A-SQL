...
::: {.callout-important icon="false" appearance="simple"}
Un parquet de :cookie: est à retirer dans le bureau du professeur pour la joueuse détentrice de la meilleure perf !

Et un bel article sur le site de notre partenaire premium, la [Fédération Française de la Lose](https://fflose.com/){target="_blank"} pour l'autrice de la contre-perf.
:::
