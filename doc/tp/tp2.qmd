...
- [ ] Lancez un service **cloudBeaver**
  ...
  - ouvrez la connexion (clic droit > Open), un petit rond vert apparait :green_circle:
...
Maintenant, place à quelques exercices historiques.
...
::: {.callout-note title="Recherche dans la doc"}
- [ ] Recherchez dans la [documentation officielle PostgreSQL](https://www.postgresql.org/docs/){target="_blank"}, un moyen de répondre au besoin ci-dessous
...
- [Correction TP2](./doc/tp/correction/tp2.sql)
:::
