...
description: "TP2 - Onyxia et le Datalab pour le statisticien"
...
- [ ] Dans l'explorateur, ouvrez le dossier *work*, puis le dossier *TP2-Datalab*
...
- [ ] Positionnez-vous dans le repo : `cd /home/onyxia/work/TP2-datalab/`
...
- `git add .`
- `git commit -m "création fichier tp2"`
- `git push`
:::
