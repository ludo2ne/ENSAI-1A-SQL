...
:construction: Pourquoi S3 ? Bucket ? Connexion ?

- facilite la gestion des données -> permet de créer un DataLake
- avantages techniques
- Interdiction de manipuler de la donnée sur son ordinateur perso


### Utiliser des données

::: {.callout-important icon="false" title="Fil rouge"}
Félix est sauvé, il peut maintenant aller chercher de la margarine et du papier cadeau pour emballer quelques bricoles suite à un malheureux accident.

En attendant, Josette s'occupe en confectionnant un superbe gilet.

Elle se souviens qu'elle a noté la longeur de fil nécessaire mais ne la retrouve plus. L'info se cache dans un fichier stocké sur S3.
:::

:construction: Aller chercher l'info dans s3://ludo/diffusion/INSEE/prenoms-nat2022.parquet (attention username différent sur les datalabs)


- [ ] Entre 2005 et 2020, en quelle année le prénom *Katia* a-t-il été le plus donné ?
