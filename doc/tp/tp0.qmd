...
description: "TP0 - Onyxia et le Datalab pour le statisticien"
...
- [ ] Dans l'explorateur, ouvrez le dossier *work*, puis le dossier *TP0-Datalab*
...
- [ ] Requêtez les données
  - Créez une nouvelle celulle avec le bouton `+` de la barre d'outils
...
- [ ] Positionnez-vous dans le repo : `cd /home/onyxia/work/TP0-datalab/`
...
- `git add .`
- `git commit -m "création fichier tp1"`
- `git push`
:::
