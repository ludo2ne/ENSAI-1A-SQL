...
- [ ] Créez une requête qui permet d'avoir le nombre de naissances par année depuis l'année 2000
  - Vous pouvez ici retirez la restriction sur les *prénoms rares*
  - Classez par année décroissante
...
Filtrez les données sur l'année 2016 en retirant les prénoms rares et écrivez les requêtes suivantes :

- [ ] Comptez le nombre de prénoms distincts donnés
- [ ] Comptez le nombre de prénoms distincts donnés par sexe
- [ ] Calculez le total des prénoms distincts donnés, en prenant en compte la distinction entre les sexes
...
- [ ] Ajoutez à la dernière requête une colonne contenant un booléen qui affiche
  ...
  - False sinon
- [ ] Au lieu d'afficher ce booléen, ajouter une condition pour n'afficher que lorsque le prénom a été plus donné à des filles
