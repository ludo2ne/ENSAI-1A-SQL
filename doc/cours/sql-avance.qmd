...
UPDATE comptes SET solde = solde - 100 WHERE id = 1; -- Débiter le compte 1
UPDATE comptes SET solde = solde + 100 WHERE id = 2; -- Créditer le compte 2

COMMIT; -- Valider les modifications si tout s'est bien passé
```
...
Permet une lecture plus rapide sur une colonne utilisée fréquemment dans *WHERE*, *JOIN*, *GROUP BY*, *ORDER BY*
...
Fonction qui s'exécute automatiquement en réponse à une mise à jour d'une table
