...
description: "[Slides](02-bases-de-donnees-slides.html)"
format: 
  html: default
  revealjs:
    footer: "[Home](../../index.html) --- [Bases de Données](02-bases-de-donnees.html)"
    output-file: 02-bases-de-donnees-slides.html
categories:
  - Tables
  - Clé primaire
  - Clé étrangère
...
digraph {
    ...
    node [shape=rect, style="rounded,filled", fillcolor=lightgrey, margin=0.1];
    edge [color=grey];
...
- *employe ([id_employe]{.underline}, nom, prenom, #id_chef)*
...
:::{.notes}
environs égal à Base de données
Boite noire
:::
...
- [DBeaver](https://dbeaver.io/){target="_blank"} ou cloudBeaver
