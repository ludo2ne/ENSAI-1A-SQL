...
format: 
  ...
  revealjs:
    theme: moon
    footer: "[Home](../../index.html) --- [SQL](sql-intro.html)"
...
::: {.callout-warning}
Généralement un message d'avertissement vous demande si vous êtes certains de vouloir mettre à jour toutes les lignes.
:::
...
Vous avez exécuté par erreur `DELETE FROM joueuse;` 
...
:construction: TODO à approfondir plus tard
...
Joueuse dont le mail n'est pas renseigné :
